...
export interface SystemDataViewField {
  Name: string;
  FieldType: MCEFieldType;
  MaxLength?: number;
}

const DATA_VIEW_FIELDS = new Map<string, SystemDataViewField[]>([
  // =========================================================================
  // EMAIL DATA VIEWS
  // =========================================================================
  ...
  [
    ...
    [
      ...
      { Name: "FromEmail", FieldType: "EmailAddress" },
      ...
      { Name: "TestEmailAddr", FieldType: "EmailAddress" },
      { Name: "Category", FieldType: "Text", MaxLength: 100 },
      { Name: "BccEmail", FieldType: "EmailAddress" },
  ...
  [
    ...
    [
      { Name: "SubscriberID", FieldType: "Number" },
      { Name: "SubscriberKey", FieldType: "EmailAddress" },
      { Name: "ListID", FieldType: "Number" },
      { Name: "BatchID", FieldType: "Number" },
      { Name: "SocialSharingSiteID", FieldType: "Number" },
      { Name: "SiteName", FieldType: "Text" },
  ...
  [
    ...
    [
      ...
      { Name: "AutomationNotificationRecipient_Complete", FieldType: "Text", MaxLength: 500 },
      { Name: "AutomationNotificationRecipient_Error", FieldType: "Text", MaxLength: 500 },
      { Name: "AutomationNotificationRecipient_Skip", FieldType: "Text", MaxLength: 500 },
      ...
      { Name: "AutomationInstanceActivityErrorDetails", FieldType: "Text", MaxLength: 4000 },
    ],
  ],
  ...
  [
    ...
    [
      ...
      { Name: "ActivityInstanceStatusDetails", FieldType: "Text", MaxLength: 4000 },
    ],
  ],
...
function normalizeDataViewName(name: string): string {
...
export function isSystemDataView(name: string): boolean {
  const normalized = normalizeDataViewName(name);
  for (const key of DATA_VIEW_FIELDS.keys()) {
...
export function getSystemDataViewFields(name: string): SystemDataViewField[] {
  const normalized = normalizeDataViewName(name);
  for (const [key, fields] of DATA_VIEW_FIELDS.entries()) {
    if (key.toUpperCase() === normalized) {
      return fields;
    }
  }
...
export function getSystemDataViewNames(): string[] {
  return Array.from(DATA_VIEW_FIELDS.keys());
}
