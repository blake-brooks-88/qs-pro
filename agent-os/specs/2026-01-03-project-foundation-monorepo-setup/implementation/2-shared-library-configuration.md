...
## Key Changes
- **@qpp/eslint-config**: Set up with strict TypeScript and security rules.
- **@qpp/shared-types**: Initialized with Zod and exported `EnvVarSchema`.
- **@qpp/database**: Configured with Drizzle ORM and Postgres driver. Included basic schema and connection utility.
